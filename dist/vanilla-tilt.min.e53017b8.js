...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/vanilla-tilt.min.js":[function(require,module,exports) {
    ...
    _createClass(t, [{
      ...
      value: function getElementListener() {
        ...
        if ("string" == typeof this.settings["mouse-event-element"]) {
          var _t12 = document.querySelector(this.settings["mouse-event-element"]);
      ...
      value: function prepareGlare() {
        if (!this.glarePrerender) {
          ...
          _t13.classList.add("js-tilt-glare");

          var e = document.createElement("div");
          e.classList.add("js-tilt-glare-inner"), _t13.appendChild(e), this.element.appendChild(_t13);
        }
      ...
      key: "extendSettings",
      value: function extendSettings(_t10) {
        var e = {
          reverse: !1,
          max: 15,
          startX: 0,
        ...
        for (var s in e) {
          if (s in _t10) i[s] = _t10[s];else if (this.element.hasAttribute("data-tilt-" + s)) {
            var _t14 = this.element.getAttribute("data-tilt-" + s);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/vanilla-tilt.min.js"], null)
//# sourceMappingURL=/vanilla-tilt.min.e53017b8.js.map